        ...
        <div className = "about">
            <div className ="row">
                <div className = "about-text col-md-5">
                    <h1 id = "hideMe"><span>A</span><span>b</span><span>o</span><span>u</span><span>t</span><span>&nbsp;</span><span>m</span><span>e</span></h1>
                    <p>I'm a MERN stack developer specialized in React and Node.js.</p>
                    <p>I have 1+ years of development experience building fullstack products from scratch, developing and integrating APIs, and working with a variety of databases.</p>
                    <p>The Front-end use of HTML, CSS, ReactJS and Bootstrap to build a web application that can communicate with Back-end via Restful API.</p>
